...
TaixiuListener = BaseListener.extend({
    ...
    handleData: function(a, b) {
        ...
        case c.TAI_XIU_INFO:
            ...
            //null != e && e.responseTaiXiuInfo(d.gameId, d.moneyType, d.referenceId, d.remainTime, d.bettingState, d.potTai, d.potXiu, d.betTai, d.betXiu, d.dice1, d.dice2, d.dice3, d.remainTimeRutLoc);
        ...
        case c.UPDATE_RESULT_DICES:
            ...
            //e && e.responseTaiXiu(d.result, d.dice1, d.dice2, d.dice3);
        ...
        case c.START_NEW_GAME_TAI_XIU:
            ...
            //e.responseStartNewGameTaiXiu(d.referenceId, d.remainTimeRutLoc);
